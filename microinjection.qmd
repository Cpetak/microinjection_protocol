...
:::{.callout-tip icon="false" collapse="true" appearance="minimal"}
### gDNA
HindIII digested and purified genomic DNA extracted from urchin epidermal tissue.
:::
...
Put a piece of clay on the side of a table and push the needle upside down into it. Fill needle by touching the end of the needle with the tip of the pipette and pushing out the liquid with the pipette. Make sure that the liquid enters the needle instead of just sitting on top. 
...
Row the eggs on the petri dish parallel and in-between the two lines mentioned above using a pipette. Row the eggs right before the injections, because fertilization problems may occur due to prolonged exposure to 3-AT sea water.
