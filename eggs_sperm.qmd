...
[Pdf version with images](https://cpetak.github.io/eggs_sperm.pdf)

::: {.callout-tip icon="false" collapse="true" appearance="minimal"}
### Ingredients

-   Syringe and 0.5M KCl
-   1.5 ml tubes
-   Tips and pipettes
-   Beakers
-   80um Nylon filter mesh
-   Ice bucket with ice
:::
...
14. Dejelly eggs by pouring them through 80um mesh 3 times from 3 cm about tube opening. Too far up -\> eggs will break. Too close -\> they won’t be dejellied and will move around in petri dish during the microinjections. Note: do this shortly before microinjection.

![Dejellying by pouring eggs over the mesh from \~3cm](micro_photos/included/dejellying.jpg){width="300"}

15. Sperm can be stored in a 4°C fridge for a few days. Eggs can be stored in a 4°C fridge for 24 hours with the addition of antibiotics (50 ul of 10 mg/ml ampicillin to 10 ml of sea water with eggs).
